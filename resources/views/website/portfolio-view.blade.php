    ...
    <div class="row">
      <div class="col-md-8">
        <div class="portfolio-single-slider owl-carousel owl-theme">
          <div><img src="{{asset('contents/website')}}/images/portfolio/portfolio-big-1.jpg"></div>
          <div><img src="{{asset('contents/website')}}/images/portfolio/portfolio-big-2.jpg"></div>
          <div><img src="{{asset('contents/website')}}/images/portfolio/portfolio-big-3.jpg"></div>
          <div><img src="{{asset('contents/website')}}/images/portfolio/portfolio-big-4.jpg"></div>
          <div><img src="{{asset('contents/website')}}/images/portfolio/portfolio-big-5.jpg"></div>
          <div><img src="{{asset('contents/website')}}/images/portfolio/portfolio-big-6.jpg"></div>
        </div>
      </div>
      <div class="col-md-4">
...
<section class="related-projects section-sm bg-gray">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="content">
          <img class="img-responsive" src="{{asset('contents/website')}}/images/portfolio/portfolio-big-2.jpg">
          <div class="content">
      ...
      <div class="col-md-6">
        <div class="content">
          <img class="img-responsive" src="{{asset('contents/website')}}/images/portfolio/portfolio-big-3.jpg">
          <div class="content">
            <h4>Dribbble Redesign</h4>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas recusandae, dignissimos culpa quam debitis quibusdam magni rem quis, cum nesciunt?</p>
            <a href="#" class="btn btn-small">View Case Study</a>
