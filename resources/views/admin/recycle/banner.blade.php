...
@section('content')
            ...
            <div class="table-responsive">
              @if(Session('softdel_success'))
                <script>
                  swal({
                    title: "Success!",
                    text: "Successfully restore banner information!",
                    icon: "success",
                    timer:3000,
                  });
                </script>
              ...
              <table class="table table-hover table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{url('admin/recycle/banner/restore/'.$data->ban_id)}}"><i class="fa fa-reply"></i></a>
    ...
    <div class="modal-dialog" role="document">
      <form method="post" action="{{url('admin/recycle/banner/delete')}}">
        @csrf
